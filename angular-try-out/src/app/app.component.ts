...
@Component({
    ...
    <div class="w-auto p-4">
     <app-dynamic-table [data]="tableData" (onRowSelected)="dataHasBeenSelected($event)"></app-dynamic-table>
    </div>
   </div>
   <router-outlet />`,
...
export class AppComponent implements OnInit {
  ...
  dynamicTableRef: Signal<DynamicTableComponent> = viewChild.required(DynamicTableComponent);
